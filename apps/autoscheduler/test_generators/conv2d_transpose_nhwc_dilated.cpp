...
public:
    ...
    void generate() {
        ...
        Func f_conv_trans("conv_trans"), padded("pad"), dilated("dilated");
        ...
        dilated(c, w, h, n) = select(w % SW == 0 && h % SH == 0, padded(c, w / SW - PW, h / SH - PH, n), 0);
        ...
        Func func("func");
        func(c, w, h, n) = 0.0f;
        func(c, w, h, n) += filter(c, r.x, KW - 1 - r.y, KH - 1 - r.z)
            * dilated(r.x, (w + r.y + BW), (h + r.z + BH), n);
